...
@section('content')
    ...
    <div class="card-box">
        After setup your mail/pusher or app you must config your application cache. <a href="{{url('/cache-config')}}">Click Here</a> To config your application cache. After cache config you might need to re login
                        ...
                        <form class="form-horizontal" role="form" id="currencySettings"  data-parsley-validate novalidate>
                            ...
                            <div id="smtpDetails">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input id="" name="var_percentage" type="text" min="0" placeholder="Vat Percentage" value="{{config('restaurant.vat.vat_percentage')}}" required data-parsley-pattern="/^\S*$/" class="form-control">
                                    ...
                                    <!--<label for="hori-pass1" class="col-sm-2 control-label">Service Charge <span class="text-danger">*</span></label>
                                    <div class="col-sm-4">
                                        <input id="" name="vat_number" type="text" placeholder="Vat Number" value="{{config('restaurant.vat.vat_number')}}" required data-parsley-pattern="/^\S*$/" class="form-control">
                                    </div>-->
                                </div>
