...
Route::get('/install-success', 'HomeController@installSuccess')->name('installed');
...
Route::middleware('active.user')->group(function () {
    ...
    Route::middleware(['manager'])->group(function () {
        // User Management
        Route::get('/add-employee', 'UserController@addEmployee');
        Route::get('/all-employee', 'UserController@allEmployees');
        Route::get('/edit-employee/{id}', 'UserController@editEmployee');
        Route::get('/delete-employee/{id}', 'UserController@deleteEmployee');
        Route::post('/save-employee', 'UserController@saveEmployee');
    ...
    Route::middleware(['kitchen'])->group(function () {
        ...
        Route::get('/kitchen-stat/kitchen={id}/start={start_date}/end={end_date}', 'KitchenController@shoeKitchenStat');
    });

    // Waiter Only
    Route::middleware(['waiter'])->group(function () {
        //Dish
        Route::get('/dish-types/{dish_id}', 'RecipeController@getTypesOfDish');
        // Orders
